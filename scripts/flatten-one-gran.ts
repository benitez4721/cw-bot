...
// Cierra UN trade puntual: GRAN / SIM2776750M.
// 1) cancela el exit pending del bracket
// 2) poll hasta que el exit quede en estado terminal
// 3) Market SELL por la qty viva de la posicion
// 4) patchea forcedExitOrderId en el ctx
const TARGET = {
  entryOrderId: '954380930',
  stopOrderId: '954381081',
  symbol: 'GRAN',
